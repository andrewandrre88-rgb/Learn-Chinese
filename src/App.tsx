  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <div className="sticky top-0 z-[100] bg-gum-black text-white py-3 px-4 border-b-2 border-white flex justify-between items-center bg-opacity-95 backdrop-blur-sm">
        ...
        <button className="bg-white text-gum-black px-4 py-1 text-xs font-black rounded brutal-border hover:bg-gum-pink transition-colors">
          JOIN NOW
        </button>
      </div>
      ...
      <main className="flex-grow">
        ...
        <section className="py-24 px-4 bg-gum-yellow border-b-2 border-gum-black overflow-hidden">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <button className="brutal-btn-black text-2xl px-14 py-6 w-full lg:w-auto hover:bg-white hover:text-black">
        ...
        <section className="py-40 px-4 text-center bg-gum-pink border-b-2 border-gum-black">
          ...
          >
            ...
            <button className="brutal-btn-black bg-gum-black text-white text-3xl px-20 py-8 hover:bg-white hover:text-gum-black transition-all hover:scale-105 active:scale-95">
